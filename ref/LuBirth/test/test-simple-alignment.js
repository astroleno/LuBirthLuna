...
console.log('=== 简单对齐算法测试 ===');

// 测试北京天安门
const testPoint = { name: '北京天安门', lon: 116.3974, lat: 39.9093 };

console.log('开始测试简单对齐算法...');
console.log('修复内容: 使用简单角度计算，避免过大旋转');
...
console.log('预期yaw:', (longitudeDiff * 0.5).toFixed(1), '°');
console.log('预期pitch:', (latitudeDiff * 0.3).toFixed(1), '°');
...
function testPhaseShift() {
  ...
  const expectedYaw = adjustedLonDiff * 0.5;
  const expectedPitch = adjustedLatDiff * 0.3;
